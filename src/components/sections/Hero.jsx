...
import DashboardIllustration from '../ui/DashboardIllustration'
      ...
      <div className="max-w-[1200px] mx-auto px-[clamp(24px,5vw,80px)] w-full relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 lg:max-w-[52%]">
            ...
            <Reveal>
              <h1 className="text-[clamp(2.8rem,7vw,5rem)] font-black leading-[0.95] tracking-tighter text-gray-900">
                Inteligência{' '}
